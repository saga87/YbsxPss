...
public class YiQianShouActivity extends BaseActivity {
            ...
            if(msg.what==1) {
                ...
                switch (obj.getStatus()){
                    ...
                    case "5":
                        ...
                        btn_daifh_ddck.setVisibility(View.GONE);
                        break;
                    case "6":
                ...
                DetailsAdapter adapter = new DetailsAdapter(YiQianShouActivity.this,obj.getDetailList());
                listview_order.setAdapter(adapter);
            }
            if(msg.what==2) {
                showToast("受理成功");
                Intent intent = new Intent();
                intent.setAction("rfid_card_found5");
                intent.putExtra("position",position);
                YiQianShouActivity.this.sendBroadcast(intent);
                finish();
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yi_qian_shou);
    ...
    private void setListener() {
        btn_daifh_ddck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(YiQianShouActivity.this);
                builder.setTitle("提示");
                builder.setMessage("确定签收吗？");
                builder.setPositiveButton("确定", new DialogInterface.OnClickListener(){
                    @Override
                    public void onClick(DialogInterface dialog, int which){
                        model.affirmSignOrder(obj.getOrderId(), new ICallBack() {
                            @Override
                            public void succeed(Object object) {
    ...
    private void setView() {
        tv_order_username = (TextView) findViewById(R.id.tv_yiqs_username);
        tv_order_userphone = (TextView) findViewById(R.id.tv_yiqs_userphone);
        tv_order_useraddress = (TextView) findViewById(R.id.tv_yiqs_useraddress);
        tv_order_pssname = (TextView) findViewById(R.id.tv_yiqs_pssname);
        tv_order_pssphone = (TextView) findViewById(R.id.tv_yiqs_pssphone);
        tv_order_pssaddress = (TextView) findViewById(R.id.tv_yiqs_pssaddress);
        tv_order_ddbh = (TextView) findViewById(R.id.tv_yiqs_ddbh);
        tv_order_ddzt = (TextView) findViewById(R.id.tv_yiqs_ddzt);
        tv_order_xdren = (TextView) findViewById(R.id.tv_yiqs_xdren);
        tv_order_xdsj = (TextView) findViewById(R.id.tv_yiqs_xdsj);
        tv_order_pssj = (TextView) findViewById(R.id.tv_yiqs_pssj);
        btn_daifh_ddck = (Button) findViewById(R.id.btn_yiqs_ddck);
        listview_order = (ListView) findViewById(R.id.listview_yiqs);
        iv_back = findViewById(R.id.iv_yiqs_back);
    }
}
