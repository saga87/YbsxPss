...
public class NewSupplierActivity extends BaseActivity {
        ...
        public void handleMessage(Message msg) {
            ...
            if(msg.what==1) {
                for (int i =0;i<provinces.size();i++) {
                    ...
                    names.add(typename);
                    if(provinces.get(i).getDept_name().equals("山东省")){
                        str1 = i;
                    }
                }
                ArrayAdapter<String> arr_adapter1 = new ArrayAdapter<String>(NewSupplierActivity.this, android.R.layout.simple_spinner_dropdown_item, names);
                //设置样式
            ...
            if(msg.what==2) {
                ...
                for (int i =0;i<cities.size();i++) {
                    ...
                    names1.add(typename);
                    if (cities.get(i).getDept_name().equals("潍坊市")) {
                        str2 = i;
                    }
                }
                ArrayAdapter<String> arr_adapter1 = new ArrayAdapter<String>(NewSupplierActivity.this, android.R.layout.simple_spinner_dropdown_item, names1);
                //设置样式
                arr_adapter1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
            ...
            if(msg.what==3) {
                ...
                for (int i =0;i<regions.size();i++) {
                    ...
                    names2.add(typename);
                    if(regions.get(i).getDept_name().equals("寿光市")){
                        str3 = i;
                    }
                }
                if(regions.size()==0){
                ...
                ArrayAdapter<String> arr_adapter1 = new ArrayAdapter<String>(NewSupplierActivity.this, android.R.layout.simple_spinner_dropdown_item, names2);
                //设置样式
                arr_adapter1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
            ...
            if(msg.what==4) {
                Toast.makeText(NewSupplierActivity.this,"保存成功",Toast.LENGTH_SHORT).show();
                Intent intent = new Intent();
                intent.setAction("rfid_card_supplierlist");
                NewSupplierActivity.this.sendBroadcast(intent);
                finish();
            }
            if(msg.what==5) {
                Toast.makeText(NewSupplierActivity.this,"保存失败"+msg1,Toast.LENGTH_SHORT).show();
            }
        }
    };
    ...
    private void setListener() {
        ...
        name.add("专业合作社");
        name.add("农户");
        ArrayAdapter<String> arr_adapter1 = new ArrayAdapter<String>(NewSupplierActivity.this, android.R.layout.simple_spinner_dropdown_item, name);
        //设置样式
        arr_adapter1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        ...
        btn_new_supplier_bc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(ghsmc.equals("")||ghslxId.equals("")||regionsId.equals("")||xxdz.equals("")||fzr.equals("")||lxdh.equals("")) {
                    Toast.makeText(NewSupplierActivity.this,"数据不能为空，请填写数据",Toast.LENGTH_SHORT).show();
                    return;
                }
                model.addSupplier(ghsmc, ghslxId, regionsId, xxdz, fzr, lxdh, new ICallBack() {
                    public void succeed(Object object) {
    ...
    private void setView() {
        sp_new_supplier_ghslx = (Spinner) findViewById(R.id.sp_new_supplier_ghslx);
        sp_new_supplier_dq1 = (Spinner) findViewById(R.id.sp_new_supplier_dq1);
        sp_new_supplier_dq2 = (Spinner) findViewById(R.id.sp_new_supplier_dq2);
        sp_new_supplier_dq3 = (Spinner) findViewById(R.id.sp_new_supplier_dq3);
        et_new_supplier_ghsmc = (EditText) findViewById(R.id.et_new_supplier_ghsmc);
        et_new_supplier_xxdz = (EditText) findViewById(R.id.et_new_supplier_xxdz);
        et_new_supplier_fzr = (EditText) findViewById(R.id.et_new_supplier_fzr);
        et_new_supplier_lxdh = (EditText) findViewById(R.id.et_new_supplier_lxdh);
        btn_new_supplier_bc = (Button) findViewById(R.id.btn_new_supplier_bc);
        iv_back = findViewById(R.id.iv_new_supplier_back);
    }
}
