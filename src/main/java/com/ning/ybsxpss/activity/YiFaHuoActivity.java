...
public class YiFaHuoActivity extends BaseActivity {
    ...
    private Handler handler= new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if(msg.what==1) {
                ...
                DetailsAdapter adapter = new DetailsAdapter(YiFaHuoActivity.this,obj.getDetailList());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yi_fa_huo);
    ...
    private void setView() {
        tv_order_username = (TextView) findViewById(R.id.tv_yifahuo_username);
        tv_order_userphone = (TextView) findViewById(R.id.tv_yifahuo_userphone);
        tv_order_useraddress = (TextView) findViewById(R.id.tv_yifahuo_useraddress);
        tv_order_pssname = (TextView) findViewById(R.id.tv_yifahuo_pssname);
        tv_order_pssphone = (TextView) findViewById(R.id.tv_yifahuo_pssphone);
        tv_order_pssaddress = (TextView) findViewById(R.id.tv_yifahuo_pssaddress);
        tv_order_ddbh = (TextView) findViewById(R.id.tv_yifahuo_ddbh);
        tv_order_ddzt = (TextView) findViewById(R.id.tv_yifahuo_ddzt);
        tv_order_xdren = (TextView) findViewById(R.id.tv_yifahuo_xdren);
        tv_order_xdsj = (TextView) findViewById(R.id.tv_yifahuo_xdsj);
        tv_order_pssj = (TextView) findViewById(R.id.tv_yifahuo_pssj);
        listview_order = (ListView) findViewById(R.id.listview_yifahuo);
        iv_back = findViewById(R.id.iv_yifahu_back);
    }
}
