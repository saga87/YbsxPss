...
public class XiaJiaAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public XiaJiaAdapter(Context context, List<GoodsMaintainList> mList, GoodsModel model, Handler handler) {
        this.texts = mList;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.list_item_xiajia, parent, false);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            item_shangjia_image = view.findViewById(R.id.item_xiajia_image);
            item_shangjia_id = view.findViewById(R.id.item_xiajia_id);
            item_shangjia_name = view.findViewById(R.id.item_xiajia_name);
            item_shangjia_price = view.findViewById(R.id.item_xiajia_price);
            item_shangjia_type = view.findViewById(R.id.item_xiajia_type);
            item_shangjia_num = view.findViewById(R.id.item_xiajia_num);
            item_shangjia_xiajia = view.findViewById(R.id.item_xiajia_xiajia);
            item_shangjia_xiugai = view.findViewById(R.id.item_xiajia_xiugai);
        }
    }
