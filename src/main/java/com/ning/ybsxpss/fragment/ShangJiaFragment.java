...
public class ShangJiaFragment extends android.support.v4.app.Fragment {
    private View view;
    ...
    private Handler handler= new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if(msg.what==1) {
                ...
                mAdapter = new ShangJiaAdapter(getActivity(),lists,model,handler);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_shangjia,null);
        setView();
        setListener();
        getmodel();
        return view;
    ...
    private void getmodel() {
        ...
        page = 1;
        model.getGoodsList(page, num,"0", new ICallBack() {
            @Override
    ...
    private void setView() {
        mRecyclerView = view.findViewById(R.id.recycler_shangjia);
    }
