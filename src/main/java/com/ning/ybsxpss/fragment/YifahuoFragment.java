...
public class YifahuoFragment extends android.support.v4.app.Fragment {
    private View view;
    private XRecyclerView mRecyclerView;
    private YifahuoAdapter mAdapter;
    ...
    private Handler handler= new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if(msg.what==1) {
                ...
                mAdapter = new YifahuoAdapter(getActivity(),lists);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_yifahuo,null);
        setView();
        setListener();
        getmodel();
        return view;
    ...
    private void getmodel() {
        ...
        page = 1;
        model.getOrderList_yfh(page, num, new ICallBack() {
            @Override
    ...
    private void setView() {
        mRecyclerView = view.findViewById(R.id.recycler_yifahuo);
    }
}
